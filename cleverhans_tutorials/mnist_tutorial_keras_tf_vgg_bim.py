"""
This tutorial shows how to generate adversarial examples using BIM (extension of FGSM)
...
from cleverhans.utils_keras_vgg import VGG_model
...
def mnist_tutorial(train_start=0, train_end=60000, test_start=0,
  ...
  model = VGG_model(img_rows=img_rows, img_cols=img_cols,
...
#        assert X_test.shape[0] == test_end - test_start, X_test.shape
  ...
  model_2 = VGG_model(img_rows=img_rows, img_cols=img_cols,
                      channels=nchannels, nb_filters=64,
                      nb_classes=nb_classes)
