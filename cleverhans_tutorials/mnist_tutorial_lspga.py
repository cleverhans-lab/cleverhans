...
def mnist_tutorial(train_start=0, train_end=60000, test_start=0,
                   ...
                   nb_filters=64):
    """
    MNIST cleverhans tutorial for LSPGA attack
    ...
    :param levels: number of levels to discretize input to
    :param thermometer: whether to encode it using thermometer
    :param steps: number of steps of the attack
    ...
    x_discretized = discretize_uniform(x, levels, thermometer=thermometer)
    ...
    lspga_params = {'eps': 0.3, 'levels':16, 'steps':10, 'attack_step':1.0,
                    'noisy_grads': False, thermometer: True}
    ...
    if clean_train:
        ...
        # Initialize the Logit-Space Projected Gradient Ascent (LSPGA)
        # attack object and graph
        lspga = LSPGA(model)
        adv_x = lspga.generate(x, **lspga_params)
