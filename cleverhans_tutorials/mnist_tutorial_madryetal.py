...
from cleverhans_tutorials.tutorial_models import make_madryetal
...
def mnist_tutorial(train_start=0, train_end=60000, test_start=0,
    ...
    model_2 = make_madryetal()
    preds_2 = model_2(x)
    attack2 = MadryEtAl(model_2, sess=sess)
    adv_x_2 = attack2.generate(x, **attack_params)
    if not backprop_through_attack:
        # For the attack used in this tutorial, the attack has zero
