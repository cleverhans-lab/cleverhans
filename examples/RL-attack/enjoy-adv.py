...
def parse_args():
  ...
  boolean_flag(
      parser, "noisy2", default=False, help="whether or not to NoisyNetwork")
  boolean_flag(
  ...
  if args.blackbox:
    with g2.as_default():
      ...
      with m1.get_session().as_default():
        ...
        play(env, m1.get_act(), craft_adv_obs, craft_adv_obs2, args.stochastic,
             args.video, args.attack, m1, m2)
  else:
    with m1.get_session().as_default():
      craft_adv_obs = m1.craft_adv()
      play(env, m1.get_act(), craft_adv_obs, None, args.stochastic, args.video,
           args.attack, m1, m1)
