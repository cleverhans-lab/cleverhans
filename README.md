...
You can check your code by running `nosestests cleverhans/devtools/tests_test_format.py` or check an individual file by running `pylint <file>` from inside the cleverhans repository root directory.
